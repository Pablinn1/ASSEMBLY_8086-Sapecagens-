...
sub al, 11h      ; Subtraio 11h de AL para que A (41h) se torne 30h, B (42h) se torne 31h , e assim por diante até F
mov bl, al       ; Copio o valor de AL para BL, pois o DL será usado para imprimir os dígitos

; Imprime o primeiro dígito '1' para valores A, B, C, D, E, F (decimais 1-5)
